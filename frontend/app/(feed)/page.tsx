                    ...
                    <div className="_nav_custom_container">
                        ...
                        >
                            ...
                            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                                ...
                                <li className="nav-item _header_nav_item">
                                    <a
                                        className="nav-link _header_nav_link _nav_before_none"
                                        aria-current="page"
                                        href="#"
                                    >
                                        <svg
                            ...
                            <div className="_header_nav_profile_wrap _header_nav_light">
                                        ...
                                        <span className="_header_nav_light_link_ic2">
                                            ...
                                            >
                                                ...
                                                <path
                                                    stroke="#1890FF"
                                                    stroke-linecap="round"
                                                    d="M2.778 9H1M17 9h-1.777M4.6 4.6L3.343 3.343M14.656 14.657L13.4 13.4M9 2.778V1M9 17v-1.778M13.4 4.6l1.257-1.257M3.344 14.657L4.6 13.4"
                                                />
                                            </svg>
                                        </span>
                                    </button>
                                ...
                                <div className="_header_nav_profile">
                                    ...
                                    <div
                                        id="_prfoile_drop"
                                        className="_nav_profile_dropdown"
                                    >
                                        ...
                                        <li className="_mobile_navigation_bottom_item">
                                            ...
                                            >
                                                ...
                                                >
                                                    <g opacity=".6">
                                                        <path
                                                            className="_mobile_svg1 _dark_svg"
                                                            stroke="#000"
                                                            stroke-linecap="round"
                                                            stroke-linejoin="round"
                                                            stroke-width="1.5"
                                                            d="M23.999 24.5v-2.333a4.667 4.667 0 00-4.667-4.667H9.999a4.667 4.667 0 00-4.667 4.667V24.5M14.667 12.833a4.667 4.667 0 100-9.333 4.667 4.667 0 000 9.333z"
                                                        />
                                                    </g>
                                                </svg>
                                            </a>
                                        ...
                                        <div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                                            ...
                                            <div className="_feed_right_inner_slider _mar_b24">
                                                <div className="_feed_inner_story_arrow">
                                                    <button
                                                        type="button"
                                                        className="_feed_inner_story_arrow_btn _arrow_bg"
                                                    >
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            width="8"
                                            ...
                                            <div className="_left_inner_event_content">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <path
                                                            fill="#fff"
                                                            d="M2 5.994c-1.1 0-2 .9-2 1.999C0 9.092.9 9.99 2 9.99s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm12 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm-6 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999z"
                                                        />
                                                        <path
                                                            fill="#4E5D78"
                                                            d="M2 5.994c-1.1 0-2 .9-2 1.999C0 9.092.9 9.99 2 9.99s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm12 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm-6 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999z"
                                            ...
                                            <div className="_feed_right_inner_area_card_ppl ">
                                                ...
                                                <div className="_feed_right_inner_area_card_ppl_side">
                                                    {" "}
                                                    <span className="_feed_right_inner_area_card_ppl_side_txt">
                                                        2 min
                                                    </span>
                                                </div>
                                            </div>
