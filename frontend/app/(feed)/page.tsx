				...
				<div className="_nav_custom_container">
					<div className="_logo_wrap">
						<a className="navbar-brand" href="feed2.html">
							<ImageComponents src="/images/logo.svg" alt="Image" className="_nav_logo"/>
						</a>
					</div>
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link_active _header_nav_link _nav_before_none" aria-current="page" href="feed2.html">
							...
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link _nav_before_none" aria-current="page" href="#">
							...
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link _nav_before_none" aria-current="page" href="#">
									...
									</svg> <span className="_counting">6</span> 
								</a>
							</li>
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link _nav_before_none" aria-current="page" href="chat.html">
						...
						<div className="_header_nav_profile_wrap _header_nav_light">
							<div className="_header_nav_mode_switch_wrap">
								<button className="_header_nav_mode_btn _header_nav_light_link">
									<span className="_header_nav_light_link_ic1">
										<svg xmlns="http://www.w3.org/2000/svg" width="13" height="18" fill="none" viewBox="0 0 13 18">
                                            <path fill="#1890FF" d="M2.828 15.03l.222.448-.222-.448zm-1.824 1.297l-.494.08.494-.08zm2.78-15.084L4.067.83l-.281.413zM11.353 9a7.5 7.5 0 00-7.5-7.5v-1a8.5 8.5 0 018.5 8.5h-1zm-7.5 7.5a7.5 7.5 0 007.5-7.5h1a8.5 8.5 0 01-8.5 8.5v-1zm-1.037-.071c.339.047.685.071 1.038.071v1c-.399 0-.79-.027-1.175-.08l.137-.991zm-.21-1.847a7.5 7.5 0 004.177-6.725h1a8.5 8.5 0 01-4.732 7.62l-.444-.896zm4.177-6.725a7.492 7.492 0 00-3.28-6.2L4.067.83a8.492 8.492 0 013.716 7.027h-1zm-4.104 9.562c-.543-.075-1.01-.138-1.342-.235-.311-.091-.745-.282-.826-.777l.987-.16c-.021-.131-.145-.1.12-.023.244.072.619.125 1.198.205l-.137.99zm.372-1.941c-.641.317-1.078.535-1.353.715a.965.965 0 00-.215.172c-.01.013.029-.037.015-.118l-.987.16a.836.836 0 01.183-.656c.12-.155.287-.284.456-.394.338-.222.842-.471 1.457-.775l.444.896zM3.853 1.5a.376.376 0 00.359-.274.365.365 0 00-.146-.396l-.563.826a.635.635 0 01-.256-.694A.625.625 0 013.853.5v1z"/>
                                        </svg>  
									</span>
									<span className="_header_nav_light_link_ic2">
										<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 18 18">
											<circle cx="9" cy="9" r="3.056" stroke="#1890FF" transform="rotate(-90 9 9)"/>
											<path stroke="#1890FF" stroke-linecap="round" d="M2.778 9H1M17 9h-1.777M4.6 4.6L3.343 3.343M14.656 14.657L13.4 13.4M9 2.778V1M9 17v-1.778M13.4 4.6l1.257-1.257M3.344 14.657L4.6 13.4"/>
										</svg>
									</span>
								</button>
							</div>
							<div className="_header_nav_profile">
								<div className="_header_nav_profile_image">
									<ImageComponents src="/images/profile.png" alt="Image" className="_nav_profile_img"/>
								</div>
								...
								<div id="_prfoile_drop" className="_nav_profile_dropdown">
									<div className="_nav_profile_dropdown_info">
										<div className="_nav_profile_dropdown_image">
											<ImageComponents src="/images/profile.png" alt="Image" className="_nav_drop_img"/>
										</div>
								...
								<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div className="_header_mobile_menu_top_inner">
										<div className="_header_mobile_menu_logo">
											<a href="feed2.html" clas="_mobile_logo_link">
												<ImageComponents src="/images/logo.svg" alt="Image" className="_nav_logo"/>
											</a>
										</div>
							...
							<div className="col-xl-12 col-lg-12 col-md-12">
								<ul className="_mobile_navigation_bottom_list">
									<li className="_mobile_navigation_bottom_item">
										<a href="feed2.html" className="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active">
									...
									<div className="_left_inner_area_suggest _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
										...
										<div className="_left_inner_area_suggest_info">
											<div className="_left_inner_area_suggest_info_box">
												<div className="_left_inner_area_suggest_info_image">
													<a href="profile.html">
														<ImageComponents src="/images/people1.png" alt="Image" className="_info_img"/>
													</a>
												</div>
										...
										<div className="_left_inner_area_suggest_info">
											<div className="_left_inner_area_suggest_info_box">
												<div className="_left_inner_area_suggest_info_image">
													<a href="profile.html">
														<ImageComponents src="/images/people2.png" alt="Image" className="_info_img1"/>
													</a>
												</div>
												<div className="_left_inner_area_suggest_info_txt">
													<a href="profile.html">
										...
										<div className="_left_inner_area_suggest_info">
											<div className="_left_inner_area_suggest_info_box">
												<div className="_left_inner_area_suggest_info_image">
													<a href="profile.html">
														<ImageComponents src="/images/people3.png" alt="Image" className="_info_img1"/>
													</a>
												</div>
												<div className="_left_inner_area_suggest_info_txt">
														<a href="profile.html">
										...
										<div className="_right_inner_area_info_ppl">
											<div className="_right_inner_area_info_box">
												<div className="_right_inner_area_info_box_image">
													<a href="profile.html">
														<ImageComponents src="/images/Avatar.png" alt="Image" className="_ppl_img"/>
													</a>
												</div>
										...
										<a className="_left_inner_event_card_link" href="event-single.html">
											<div className="_left_inner_event_card">
												<div className="_left_inner_event_card_iamge">
													<ImageComponents src="/images/feed_event1.png" alt="Image" className="_card_img"/>
												</div>
									...
									<div className="_feed_inner_ppl_card _mar_b16">
										...
										<div className="row">
											<div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 col">
												<div className="_feed_inner_profile_story _b_radious6 ">
													<div className="_feed_inner_profile_story_image">
														<ImageComponents src="/images/card_ppl1.png" alt="Image" className="_profile_story_img">
											...
											<div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 col">
												<div className="_feed_inner_public_story _b_radious6">
													<div className="_feed_inner_public_story_image">
														<ImageComponents src="/images/card_ppl2.png" alt="Image" className="_public_story_img"/>
														<div className="_feed_inner_pulic_story_txt">
															<p className="_feed_inner_pulic_story_para">Ryan Roslansky</p>
														</div>
														<div className="_feed_inner_public_mini">
															<ImageComponents src="/images/mini_pic.png" alt="Image" className="_public_mini_img"/>
														</div>
													</div>
												</div>
											</div>
											<div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 _custom_mobile_none">
												<div className="_feed_inner_public_story _b_radious6">
													<div className="_feed_inner_public_story_image">
														<ImageComponents src="/images/card_ppl3.png" alt="Image" className="_public_story_img">
														<div className="_feed_inner_pulic_story_txt">
															<p className="_feed_inner_pulic_story_para">Ryan Roslansky</p>
														</div>
														<div className="_feed_inner_public_mini">
											...
											<div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 _custom_none">
												<div className="_feed_inner_public_story _b_radious6">
													<div className="_feed_inner_public_story_image">
														<ImageComponents src="/images/card_ppl4.png" alt="Image" className="_public_story_img"/>
														<div className="_feed_inner_pulic_story_txt">
															<p className="_feed_inner_pulic_story_para">Ryan Roslansky</p>
														</div>
														<div className="_feed_inner_public_mini">
												...
												<li className="_feed_inner_ppl_card_area_item">
													<a href="#0" className="_feed_inner_ppl_card_area_link">
														<div className="_feed_inner_ppl_card_area_story">
															<ImageComponents src="/images/mobile_story_img.png" alt="Image" className="_card_story_img"/>
												...
												<li className="_feed_inner_ppl_card_area_item">
													<a href="#0" className="_feed_inner_ppl_card_area_link">
														<div className="_feed_inner_ppl_card_area_story_active">
															<ImageComponents src="/images/mobile_story_img1.png" alt="Image" className="_card_story_img1"/>
														</div>
												...
												<li className="_feed_inner_ppl_card_area_item">
													<a href="#0" className="_feed_inner_ppl_card_area_link">
														<div className="_feed_inner_ppl_card_area_story_inactive">
															<ImageComponents src="/images/mobile_story_img2.png" alt="Image" className="_card_story_img1"/>
														</div>
														<p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
													</a>
												</li>
									...
									<div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
										<div className="_feed_inner_text_area_box">
											<div className="_feed_inner_text_area_box_image">
												<ImageComponents src="/images/txt_img.png" alt="Image" className="_txt_img"/>
											</div>
											<div className="form-floating _feed_inner_text_area_box_form ">
												<textarea className="form-control _textarea" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
												<label className="_feed_textarea_label" for="floatingTextarea">Write something ...
									...
									<div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
										<div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
											<div className="_feed_inner_timeline_post_top">
												<div className="_feed_inner_timeline_post_box">
													<div className="_feed_inner_timeline_post_box_image">
														<ImageComponents src="/images/post_img.png" alt="" className="_post_img"/>
													</div>
													<div className="_feed_inner_timeline_post_box_txt">
														<h4 className="_feed_inner_timeline_post_box_title">Karim Saif</h4>
														<p className="_feed_inner_timeline_post_box_para">5 minute ago .	<a href="#0">Public</a>
														</p>
													</div>
												</div>
												<div className="_feed_inner_timeline_post_box_dropdown">
													...
													<!--Dropdown-->
													<div id="_timeline_drop" className="_feed_timeline_dropdown">
											...
											<div className="_feed_inner_timeline_image">
												<ImageComponents src="/images/timeline_img.png" alt="" className="_time_img"/>
											</div>
										</div>
										<div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
											<div className="_feed_inner_timeline_total_reacts_image">
												<ImageComponents src="/images/react_img1.png" alt="Image" className="_react_img1"/>
												<ImageComponents src="/images/react_img2.png" alt="Image" className="_react_img"/>
												<ImageComponents src="/images/react_img3.png" alt="Image" className="_react_img _rect_img_mbl_none"/>
												<ImageComponents src="/images/react_img4.png" alt="Image" className="_react_img _rect_img_mbl_none"/>
												<ImageComponents src="/images/react_img5.png" alt="Image" className="_react_img _rect_img_mbl_none"/>
										...
										<div className="_feed_inner_timeline_reaction">
											<button className="_feed_inner_timeline_reaction_emoji _feed_reaction _feed_reaction_active">	<span className="_feed_inner_timeline_reaction_link"> <span>
                                                    <svg  xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="none" viewBox="0 0 19 19">
											...
											<button className="_feed_inner_timeline_reaction_comment _feed_reaction">	<span className="_feed_inner_timeline_reaction_link"> <span>
											...
											<button className="_feed_inner_timeline_reaction_share _feed_reaction">	<span className="_feed_inner_timeline_reaction_link"> <span>
												...
												<form className="_feed_inner_comment_box_form">
													<div className="_feed_inner_comment_box_content">
														<div className="_feed_inner_comment_box_content_image">
															<ImageComponents src="/images/comment_img.png" alt="" className="_comment_img"/>
														</div>
											...
											<div className="_comment_main">
												<div className="_comment_image">
													<a href="profile.html" className="_comment_image_link">
														<ImageComponents src="/images/txt_img.png" alt="" className="_comment_img1"/>
													</a>
												</div>
									...
									<div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
										<div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
											<div className="_feed_inner_timeline_post_top">
												...
												<div className="_feed_inner_timeline_post_box_dropdown">
													<div className="_feed_timeline_post_dropdown">
														<a href="#0" className="_feed_timeline_post_dropdown_link">
															<svg xmlns="http://www.w3.org/2000/svg" width="4" height="17" fill="none" viewBox="0 0 4 17">
																<circle cx="2" cy="2" r="2" fill="#C4C4C4" />
																<circle cx="2" cy="8" r="2" fill="#C4C4C4" />
																<circle cx="2" cy="15" r="2" fill="#C4C4C4" />
							...
							<div className="_layout_right_sidebar_wrap">
								<div className="_layout_right_sidebar_inner">
									<div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
										...
										<div className="_feed_right_inner_slider _mar_b24">
											<div className="_feed_inner_story_arrow">
												<button type="button" className="_feed_inner_story_arrow_btn _arrow_bg">
													<svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="none" viewBox="0 0 8 8">
														<path fill="#1890FF" fill-rule="evenodd" d="M0 4c0-.245.199-.444.444-.444h7.112a.444.444 0 010 .888H.444A.444.444 0 010 4z" clip-rule="evenodd" />
														<path fill="#1890FF" fill-rule="evenodd" d="M0 4c0-.245.199-.444.444-.444h7.112a.444.444 0 010 .888H.444A.444.444 0 010 4z" clip-rule="evenodd" />
														<g>
															<path fill="#1890FF" fill-rule="evenodd" d="M3.686.13a.444.444 0 01.628 0L7.87 3.686a.444.444 0 010 .628L4.314 7.87a.444.444 0 01-.628-.629L6.927 4 3.686.759a.444.444 0 010-.629z" clip-rule="evenodd" />
															<path fill="#1890FF" fill-rule="evenodd" d="M3.686.13a.444.444 0 01.628 0L7.87 3.686a.444.444 0 010 .628L4.314 7.87a.444.444 0 01-.628-.629L6.927 4 3.686.759a.444.444 0 010-.629z" clip-rule="evenodd" />
														</g>
													</svg>
												</button>
											</div>
											<div className="_feed_right_inner_slider_image">
												<ImageComponents src="/images/slider1.png" alt="Image" className="_slider_img">
											</div>
											<div className="_feed_right_inner_slider_image">
												<ImageComponents src="/images/slider2.png" alt="Image" className="_slider_img">
											</div>
											<div className="_feed_right_inner_slider_image">
												<ImageComponents src="/images/slider3.png" alt="Image" className="_slider_img">
											</div>
											<div className="_feed_right_inner_slider_image _slider_image_none">
												<ImageComponents src="/images/slider4.png" alt="Image" className="_slider_img">
											</div>
										</div>
										<div className="_left_inner_event_content">
											<h4 className="_left_inner_event_title _title5">Your Friends</h4>
											<a href="#0" className="_left_inner_event_link">
												<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
													<path fill="#fff" d="M2 5.994c-1.1 0-2 .9-2 1.999C0 9.092.9 9.99 2 9.99s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm12 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm-6 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999z" />
													<path fill="#4E5D78" d="M2 5.994c-1.1 0-2 .9-2 1.999C0 9.092.9 9.99 2 9.99s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm12 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999zm-6 0c-1.1 0-2 .9-2 1.999 0 1.099.9 1.998 2 1.998s2-.9 2-1.998c0-1.1-.9-1.999-2-1.999z" />
												</svg>
											</a>
										</div>
										<div className="_feed_right_inner_area_card_ppl ">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img1.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Kayleigh Bysouth </h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side"> <span className="_feed_right_inner_area_card_ppl_side_txt">2 min</span>
											</div>
										</div>
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img2.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Jess Phillips MP</h4>
													</a>
												</div>
											</div>
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img3.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
													<h4 className="_feed_right_inner_area_card_ppl_title _text1">MP Eslam Hisham</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side"> <span className="_feed_right_inner_area_card_ppl_side_txt">8 min</span>
											</div>
										</div>
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img4.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Levizja Vetvendos</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
												<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 14 14">
													<rect width="12" height="12" x="1" y="1" fill="#0ACF83" stroke="#fff" stroke-width="2" rx="6"></rect>
												</svg>
											</div>
										</div>
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img5.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Afrim Konjufca</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img6.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Adayin Vetvendosje</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img7.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Albini Vjosa</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side"> <span className="_feed_right_inner_area_card_ppl_side_txt">15 min</span>
											</div>
										</div>
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img8.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Eduardo Ortega</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img9.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Yasin Kawakamu</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img10.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Edilson De Carvalho </h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img11.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Albini Vjosa Glauki</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<ImageComponents src="/images/img12.png" alt="" className="_box_ppl_img">
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
														<h4 className="_feed_right_inner_area_card_ppl_title _text1">Muhamet Murteza</h4>
													</a>
												</div>
											</div>
											<div className="_feed_right_inner_area_card_ppl_side"> <span className="_feed_right_inner_area_card_ppl_side_txt">2 hr</span>
											</div>
										</div>
									</div>
								</div>
