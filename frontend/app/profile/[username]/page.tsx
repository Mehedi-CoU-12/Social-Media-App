            ...
            <div className="_profile_wrapper">
                <div className="_profile_wrap">
                    <div className="container">
                                ...
                                <div className="_profile_cover_wrap">
                                    ...
                                    <div className="_profile_card_inner">
                                        <div className="_profile_card">
                                            ...
                                            <div className="_profile_card_progress">
                                                ...
                                                <div className="_profile_card_progress_txt">
                                                    ...
                                                    <p className="_profile_card_progress_txt_percent">
                                                        55%
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="_profile_card_upload">
                                            ...
                                            <p className="_profile_card_upload_txt">
                                                Edit Cover Photo
                                            </p>
                                        </div>
                                        {/* <!--For Desktop-->
                        ...
                        {/* #--------- profile photo and cover photo section end----------- */}
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12">
                                    <div className="_layout_right_wrap">
                                        ...
                                        <div className="right_iiner_area_friends _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                                            <div className="_right_inner_area_friends_content">
                                                <h4 className="_right_inner_area_friends_content_title _title5 _mar_b24">
                                                    Your Friends
                                                </h4>
                                                <span className="_right_inner_area_friends_content_txt">
                                                    <a
                                                        className="_right_inner_area_friends_content_txt_link"
                                                        href="#0"
                                                    >
                                                        See All
                                                    </a>
