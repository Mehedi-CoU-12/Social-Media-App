                        ...
                        <li className="nav-item _header_nav_item">
                            ...
                            >
                                ...
                                {showNotifications && (
                                    <div
                                        id="_notify_drop"
                                        className={`_notification_dropdown ${showNotifications ? 'show' : ''}`}
                                    >
                    ...
                    >
                        <div className="_header_nav_profile_image">
                            <img
                                ...
                                alt="Image"
                                className="_nav_profile_img rounded-2xl"
                            />
                        </div>
                                ...
                                <div className="_nav_profile_dropdown_info">
                                    <div className="_nav_profile_dropdown_image">
                                        <img
                                            ...
                                            alt="Image"
                                            className="_nav_drop_img rounded-4xl"
                                        />
                                    </div>
